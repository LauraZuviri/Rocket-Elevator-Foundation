    ...
    $.ajax({
      ...
      success: function(buildings, status) {
        ...
        for (i = 0; i < buildings.length; i++) {
          ...
          options_string =
            options_string + "<option>" + buildings[i].id + "</option>";
          console.log(options_string);
        }
        console.log("ready to update dropdown");
        console.log(options_string);
        $("#intervention_building_id").html(
          "<option>Select</option>" + options_string
        );
      }
    });
  });
    ...
    $.ajax({
      ...
      success: function(batteries, status) {
        ...
        for (i = 0; i < batteries.length; i++) {
          ...
          options_string =
            options_string + "<option>" + batteries[i].id + "</option>";
          console.log(options_string);
        }
        console.log("ready to update dropdown");
        console.log(options_string);
        $("#intervention_battery_id").html(
          "<option>Select</option>" + options_string
        );
      }
    });
    ...
    $.ajax({
      ...
      success: function(columns, status) {
        ...
        for (i = 0; i < columns.length; i++) {
          ...
          options_string =
            options_string + "<option>" + columns[i].id + "</option>";
          console.log(options_string);
        }
        console.log("ready to update dropdown");
        console.log(options_string);
        $("#intervention_column_id").html(
          "<option>Select</option>" + options_string
        );
      }
    });
    ...
    $.ajax({
      ...
      success: function(elevators, status) {
        ...
        for (i = 0; i < elevators.length; i++) {
          ...
          options_string =
            options_string + "<option>" + elevators[i].id + "</option>";
          console.log(options_string);
        }
        console.log("ready to update dropdown");
        console.log(options_string);
        $("#intervention_elevator_id").html(
          "<option>Select</option>" + options_string
        );
      }
    });
